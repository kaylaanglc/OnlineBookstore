            ...
            <section class="mx-20 mb-4">
                ...
                <div class="mt-5 mb-5">
                    <form action="{{ route('dashboard') }}" method="get">
                        ...
                        <select name="sort_by" id="sort_by" onchange="this.form.submit()" class="bg-gray-50 mb-5 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 py-2.5 text-left inline-flex items-left dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
